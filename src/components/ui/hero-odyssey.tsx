...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-[80vh] flex flex-col justify-center">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
          className="w-full z-200 top-[10%] relative"
        >
          <motion.div variants={itemVariants}>
            <FeatureItem name="React" value="for base" position="left-0 sm:left-10 top-20" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Tailwind" value="for styles" position="left-1/4 top-0" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Framer-motion" value="for animations" position="right-1/4 top-0" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Shaders" value="for lightning" position="right-0 sm:right-10 top-20" />
          </motion.div>
        </motion.div>
        ...
        >            <ElasticHueSlider
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="mt-12 px-8 py-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-colors"
          >
